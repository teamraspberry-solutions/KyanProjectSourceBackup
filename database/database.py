...
class KyanDatabase:
    ...
    def get_last_completed_session_id(self):
        ...
        active_session_id = self.get_active_session_id()  # Fetch the active session ID
    ...
    def get_recap_details(self):
        """Fetches the recap details from recapKyan table for id = 1."""
        self.cursor.execute("""
